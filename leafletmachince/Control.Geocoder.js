(function (factory) {
	...
	L.Control.Geocoder.jsonp = function(url, params, callback, context, jsonpParam) {
		...
		// console.log(L.Util.getParamString(params));
		//console.log(script.src);
		// nameplace(script.src)
		// var x = document.getElementsByTagName('head')[0].appendChild(script);
  		// document.getElementById("nameplace").innerHTML = x
		/* NOTE */
	};

	// function namplace(link){
	// 	$.ajax({
	// 		type: "GET",
	// 		url: "https://nominatim.openstreetmap.org/reverse/?lat=14.066323&lon=100.607589&zoom=18&addressdetails=1&format=json&json_callback=_l_geocoder_0",
